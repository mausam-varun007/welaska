...
(function () {
    ...
    .controller("GoogleMaps", function($scope, $compile) {
      var map = angular.element("#playground");
      
      $scope.markers = "indore madhya pradesh india";
      $scope.showDemos = false;
      $scope.buttonText = "Show documentation";
      
      
      $scope.enable = function () {
        $scope.showDemos = !$scope.showDemos;
        $scope.buttonText = "Hide documentation";
      }
